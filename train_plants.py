...
def init_model(args):
    ...
    model = get_cityscapes_model(num_classes=6, norm_layer=norm_layer,
                                 backbone='resnet50')
...
def train(model, model_cfg, args, train_proposals, start_epoch=0,
    ...
    trainer = AdaptISTrainer(args, model, model_cfg, loss_cfg,
                             ...
                             image_dump_interval=100 if not train_proposals else 4,
...
if __name__ == '__main__':
    args = init_experiment('plants', add_exp_args, script_path=__file__)
